      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-md-3 col-sm-12 text-center nopadding-right">
               <div class="top-logo">
                  <a href="<?php echo BASE_URL ?>"><img src="<?php echo BASE_URL ?>/public/template/img/logo.gif" alt="" /></a>
               </div>
            </div>
            <!-- logo end -->
            <!-- mainmenu area start -->
               ...
               <div class="mainmenu">
                  <nav>
                     <ul>
                        ...
                        <li class="expand"><a href="#">Về chúng tôi</a></li>
               ...
               <div class="top-detail">
                  ...
                  <div class="disflow">
                     <div class="expand lang-all disflow">
                        <a href="#"><img src="<?php echo BASE_URL ?>/public/template/img/country/en.gif" alt="">English</a>
                        <ul class="restrain language">
                           <li><a href="#"><img src="<?php echo BASE_URL ?>/public/template/img/country/it.gif" alt="">italiano</a></li>
                           <li><a href="#"><img src="<?php echo BASE_URL ?>/public/template/img/country/nl_nl.gif" alt="">Nederlands</a></li>
                           <li><a href="#"><img src="<?php echo BASE_URL ?>/public/template/img/country/de_de.gif" alt="">Deutsch</a></li>
